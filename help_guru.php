          ...
          <div class="row">
            <div class="col-2 bg_sidebar">
              <ul class="navbar">
                ...
                <li class="hover"><a href="help_guru.php"><i class="fa fa-question-circle-o"></i> Help</a></li>
                      ...
                      <div class="col-12">
                        <div class="help-cont">
                          <ol>
                            ...
                            <li>Note</li>
                            <img src="help/note/note_guru.PNG" alt="">
                            <p>About berisi tentang catatan yang guru buat.</p>

                            <li>Assignment</li>
                            <img src="help/assignment/assignment_guru.PNG" alt="">
                            ...
                            <li>Quiz</li>
                            <img src="help/quiz/quiz_guru.PNG" alt="quiz_gmbr">
                            ...
                            <li>Discussion</li>
                            <img src="help/discussion/discussion_guru.PNG" alt="">
                            <p>Di Discussion anda dapat chat dengan guru, siswa, dan orang tua.</p>

                            <li>Task List</li>
                            <img src="help/task/task_guru.PNG" alt="">
