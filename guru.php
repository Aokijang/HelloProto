        ...
        <div class="col-10">
          <div class="row">
            <div class="col-2 bg_sidebar">
              <ul class="guru">
                <li class="hover"><a href="guru.php"><i class="fa fa-home"></i> Home</a></li>
                ...
                <li><a href="inbox_guru.php"><i class="fa fa-group"></i> Inbox</a></li>
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="text-cont">
                    <div class="row">
                      <div class="col-1">
                        <div class="text-img" align="right">
                          <img src="css/profile3.png" alt="">
                        </div>
                      </div>
                      <div class="col-10">
                        <div class="text-name">
                          <h1>Vanestica Ireline</h1>
                        </div>
                      </div>
                      <div class="col-1"></div>
                    </div>
