          ...
          <div class="row">
            <div class="col-2 bg_sidebar">
              <ul class="navbar">
                ...
                <li class="hover"><a href="help_ortu.php"><i class="fa fa-question-circle-o"></i> Help</a></li>
                      ...
                      <div class="col-12">
                        <div class="help-cont">
                          <ol>
                            ...
                            <li>Note</li>
                            <img src="help/note/note_ortu.PNG" alt="">
                            <p>About berisi tentang catatan yang diberikan oleh guru.</p>

                            <li>Assignment</li>
                            <img src="help/assignment/assignment_ortu.PNG" alt="">
                            ...
                            <li>Quiz</li>
                            <img src="help/quiz/quiz_ortu.PNG" alt="quiz_gmbr">
                            ...
                            <li>Discussion</li>
                            <img src="help/discussion/discussion_ortu.PNG" alt="">
                            <p>Di Discussion anda dapat chat dengan guru, siswa, dan orang tua.</p>

                            <li>Task List</li>
                            <img src="help/task/task_ortu.PNG" alt="">
