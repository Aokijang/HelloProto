          ...
          <div class="row">
            <div class="col-2 bg_sidebar">
              <ul class="navbar">
                ...
                <li class="hover"><a href="quiz_ortu.php"><i class="fa fa-gamepad" style="color: white"></i> Quiz</a></li>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="other-text-cont note-cont">
                    ...
                    <div class="quiz-cont">
                      <button type="button" name="show_quiz" id="show_quiz">Show Active Quiz</button>
                    </div>
                  </div>
                </div>
              </div>
